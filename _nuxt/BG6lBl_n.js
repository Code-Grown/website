...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function co(e,t,n){let r=new Float32Array(Ja),i=new J(0,1,0);return new Mi({name:`SphericalGaussianBlur`,defines:{n:Ja,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:fo(),fragmentShader:`
	...
	`}var po=class extends tn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new gi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=As(i,i.VERTEX_SHADER,y),S=As(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Is(i,x,`vertex`),n=Is(i,S,`fragment`);G(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
    ...
    `,fragmentShader:`
      ...
      void main() {
        ...
        float mist = smoothstep(0.05, 0.95, fresnel);
        gl_FragColor = vec4(uColor, mist * uIntensity);
      }
    `})}function ee(){if(!(!s.value||T))try{let e=Math.max(O(),120);h=new Vn,g=new fa(38,1,.1,100),g.position.set(0,0,3.15),p=new Zc({antialias:!0,alpha:!0,premultipliedAlpha:!0,powerPreference:`high-performance`}),p.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),p.setSize(e,e,!1),p.setClearColor(0,0),p.outputColorSpace=ut,p.toneMapping=4,p.toneMappingExposure=1;let t=p.domElement;Object.assign(t.style,{width:`100%`,height:`100%`,display:`block`,pointerEvents:`none`,borderRadius:`50%`,background:`transparent`}),s.value.appendChild(t),y=new ii(new Ci(.97,72,72),new Pi({map:A(),roughness:.96,metalness:0,emissive:new Z(`#bae6fd`),emissiveIntensity:.28})),h.add(y),b=new ii(new Ci(1.01,64,64),new Kr({color:`#e0f2fe`,transparent:!0,opacity:.12,depthWrite:!1})),h.add(b),x=new ii(new Ci(1.06,64,64),j(`#e0f2fe`,1.2,1.75,0)),S=new ii(new Ci(1.24,48,48),j(`#7dd3fc`,.58,1.3,1)),C=new ii(new Ci(1.42,40,40),j(`#bae6fd`,.32,1.1,1)),h.add(x,S,C),h.add(new ga(15792639,.95),new ea(16777215,805486,.65),(()=>{let e=new ha(16777215,.4);return e.position.set(2,2,3.5),e})(),(()=>{let e=new ha(12248829,.3);return e.position.set(-2.5,-1,2),e})()),E.v=a.yaw,D.v=a.pitch,c.value=!0,M()}catch(e){console.error(`[CgPlanet] WebGL init failed`,e),u.value=!0}}function M(){T||!p||!h||!g||!y||(w=requestAnimationFrame(M),E.v+=(a.yaw-E.v)*.18,D.v+=(a.pitch-D.v)*.18,y.rotation.y=E.v,y.rotation.x=D.v,p.render(h,g))}function N(){T=!0,cancelAnimationFrame(w),p&&(p.domElement.remove(),p.dispose());let e=y?.material;e?.map?.dispose(),e?.dispose(),y?.geometry.dispose();for(let e of[b,x,S,C])(e?.material)?.dispose(),e?.geometry.dispose();p=null,h=null,g=null,y=null,b=null,x=null,S=null,C=null}e(async()=>{await o(),requestAnimationFrame(()=>ee())}),m(N);let P=d(()=>{let e=typeof a.size==`number`?`${a.size}px`:a.size;return{width:e,height:e}});return(e,n)=>(v(),_(`div`,{class:f([`cg-planet`,{"cg-planet--ready":i(c),"cg-planet--failed":i(u)}]),style:t(i(P)),role:`img`,"aria-label":`Estrella de protones CodeGrown`},[n[0]||=r(`div`,{class:`cg-planet__aura`,"aria-hidden":`true`},null,-1),r(`div`,{class:`cg-planet__host`,ref_key:`host`,ref:s},null,512)],6))}}),[[`__scopeId`,`data-v-580d4f81`]]),{__name:`CgPlanet`}),$c={class:`cg-orbit__ellipse`},el={key:0,class:`cg-orbit__dust`},tl={class:`cg-orbit__ellipse cg-orbit__ellipse--ride`},nl={class:`cg-orbit__spin`},rl={class:`cg-lo__planet`},il={class:`cg-lo__moons cg-lo__moons--back`,"aria-hidden":`true`},al={class:`cg-lo__moons cg-lo__moons--front`,"aria-hidden":`true`},ol=Object.assign(x(a({__name:`CgLogoOrbit`,props:{size:{default:300},compact:{type:Boolean,default:!1},float:{type:Boolean,default:!1},interactive:{type:Boolean,default:void 0}},setup(n){let a=n,o=d(()=>a.interactive??!a.compact),s=d(()=>{if(typeof a.size==`number`)return a.size;let e=parseFloat(a.size);return Number.isFinite(e)?e:300}),p=l(s.value),h=d(()=>p.value/Math.max(s.value,1)),y=d(()=>Math.round(p.value*(a.compact?.86:.58))),b=l(null),x=l(.4),C=l(.12),w=l([]),T=l([]),E=new Map,D=!1,O=0,k=0,A=0,j=null,ee=0,M=0;function N(){if(typeof window>`u`)return;let e=s.value,t=window.innerWidth,n=e;a.compact?n=e:t<480?n=Math.min(e,Math.round(t*.46)):t<720?n=Math.min(e,Math.round(t*.44)):t<960?n=Math.min(e,Math.round(t*.4)):t<1200&&(n=Math.min(e,400)),n=Math.max(a.compact?e:220,n),n!==p.value&&(p.value=n)}let P=[`rgba(224, 242, 254, 0.58)`,`rgba(186, 230, 253, 0.5)`,`rgba(125, 211, 252, 0.45)`,`rgba(147, 197, 253, 0.42)`,`rgba(191, 219, 254, 0.4)`,`rgba(224, 242, 254, 0.35)`],F=[`mint`,`sky`,`pale`];function I(e,t){return e+Math.random()*(t-e)}function L(e){return e[Math.floor(Math.random()*e.length)]}function te(e,t){return e+Math.floor(Math.random()*(t-e+1))}function ne(e){let t=Math.floor(Math.random()*e),n=[];for(let r=0;r<e;r++){let e=Math.random()<.5?1:-1,i=r===t,a=i?I(148,198):I(115,188),o=i?I(46,70):I(40,90),s=o/a<.48;n.push({id:r,w:a,h:o,rotX:e*I(50,78),rotY:I(-26,26),rotZ:I(0,360),dashed:i||s?!1:Math.random()<.32,nebula:i,opacity:i?I(.55,.75):I(.3,.55),dur:I(18,46),delay:I(0,40),reverse:Math.random()<.45,bead:i?I(13,16):I(11,15),color:i?`rgba(186, 230, 253, 0.35)`:L(P),tone:L(F)})}return n}function re(e){let t=e.h/e.w;return{width:`${e.w}%`,height:`${e.w}%`,transform:`translate(-50%, -50%) rotateX(${e.rotX}deg) rotateY(${e.rotY}deg) rotateZ(${e.rotZ}deg)`,"--sy":String(t),"--orbit-color":e.color,"--orbit-style":e.dashed?`dashed`:`solid`,"--spin-dur":`${e.dur}s`,"--spin-delay":`${-e.delay}s`,"--spin-dir":e.reverse?`reverse`:`normal`}}let ie=d(()=>C.value*180/Math.PI*.7),ae=d(()=>x.value*180/Math.PI*.7),oe=d(()=>({transform:`rotateX(${ie.value}deg) rotateY(${ae.value}deg)`}));function se(e,t){t instanceof HTMLElement?E.set(e,t):E.delete(e)}function ce(e,t){if(!M)return!0;let n=((t-M)/1e3+e.delay)/e.dur%1,r=(e.reverse?-n:n)*Math.PI*2,i=Math.sin(r);return e.rotX>=0?i>0:i<0}function R(e){ee=requestAnimationFrame(R);let t=b.value;if(!t||!w.value.length)return;M||=e;let n=t.getBoundingClientRect(),r=[];for(let t of w.value){let i=E.get(t.id);if(!i)continue;let a=i.getBoundingClientRect();a.width<.5&&a.height<.5||r.push({id:t.id,x:a.left+a.width/2-n.left,y:a.top+a.height/2-n.top,front:ce(t,e),size:Math.max(8,Math.round(t.bead*h.value)),nebula:t.nebula,tone:t.tone})}T.value=r}function le(e){o.value&&(D=!0,A=0,O=e.clientX,k=e.clientY,j=e.pointerId,b.value?.setPointerCapture(e.pointerId))}function ue(e){if(!D)return;let t=e.clientX-O,n=e.clientY-k;O=e.clientX,k=e.clientY,A+=Math.abs(t)+Math.abs(n),x.value+=t*.01,C.value+=n*.008}function de(){if(!D)return;let e=D;D=!1;try{j!=null&&b.value?.releasePointerCapture(j)}catch{}j=null,e&&A<8&&(x.value+=Math.PI*2)}return e(()=>{N();let e=a.compact?3:te(7,9);w.value=ne(e),M=0,ee=requestAnimationFrame(R),window.addEventListener(`pointermove`,ue),window.addEventListener(`pointerup`,de),window.addEventListener(`resize`,N,{passive:!0})}),m(()=>{cancelAnimationFrame(ee),window.removeEventListener(`pointermove`,ue),window.removeEventListener(`pointerup`,de),window.removeEventListener(`resize`,N)}),(e,a)=>{let s=Qc;return v(),_(`div`,{class:f([`cg-lo`,{"cg-lo--compact":n.compact,"cg-lo--float":n.float,"cg-lo--interactive":i(o)}]),ref_key:`root`,ref:b,style:t({width:i(p)+`px`}),onPointerdown:le},[a[1]||=r(`div`,{class:`cg-lo__hit`,"aria-hidden":`true`},null,-1),r(`div`,{class:`cg-lo__orbits`,style:t(i(oe)),"aria-hidden":`true`},[(v(!0),_(S,null,g(i(w),e=>(v(),_(`div`,{class:f([`cg-orbit`,{"cg-orbit--nebula":e.nebula}]),key:`o-`+e.id,style:t(re(e))},[r(`div`,$c,[a[0]||=r(`div`,{class:`cg-orbit__ring`},null,-1),e.nebula?(v(),_(`div`,el)):c(``,!0)]),r(`div`,tl,[r(`div`,nl,[r(`i`,{class:`cg-orbit__tip`,ref_for:!0,ref:t=>se(e.id,t)},null,512)])])],6))),128))],4),r(`div`,rl,[u(s,{size:i(y),yaw:i(x),pitch:i(C)},null,8,[`size`,`yaw`,`pitch`])]),r(`div`,il,[(v(!0),_(S,null,g(i(T).filter(e=>!e.front),e=>(v(),_(`div`,{class:f([`cg-moon`,[`cg-moon--${e.tone}`,{"cg-moon--nebula":e.nebula}]]),key:`mb-`+e.id,style:t({width:e.size+`px`,height:e.size+`px`,transform:`translate(${e.x}px, ${e.y}px) translate(-50%, -50%)`})},null,6))),128))]),r(`div`,al,[(v(!0),_(S,null,g(i(T).filter(e=>e.front),e=>(v(),_(`div`,{class:f([`cg-moon`,[`cg-moon--${e.tone}`,{"cg-moon--nebula":e.nebula}]]),key:`mf-`+e.id,style:t({width:e.size+`px`,height:e.size+`px`,transform:`translate(${e.x}px, ${e.y}px) translate(-50%, -50%)`})},null,6))),128))])],38)}}}),[[`__scopeId`,`data-v-9f269296`]]),{__name:`CgLogoOrbit`}),sl={class:`cg-hero`},cl={class:`cg-container cg-hero__inner`},ll={class:`cg-hero__copy`,"data-aos":`fade-up`},ul={class:`cg-hero__title`},dl={class:`cg-hero__lead`},fl={class:`cg-hero__cta`},pl={class:`cg-hero__visual`,"data-aos":`fade-left`,"data-aos-delay":`120`},ml={class:`cg-section`},hl={class:`cg-container`},gl={class:`cg-section cg-section--alt`},_l={class:`cg-container`},vl={class:`d-flex flex-wrap align-center justify-space-between ga-4 mb-8`},yl={class:`cg-project__icon`},bl=[`src`,`alt`],xl={class:`cg-project__meta`},Sl={class:`cg-project__cat`},Cl={class:`cg-project__status`},wl={class:`cg-project__title`},Tl={class:`cg-project__text`},El={class:`cg-section`},Dl={class:`cg-container`},Ol={class:`cg-project__icon`},kl=[`src`,`alt`],Al={class:`cg-project__meta`},jl={class:`cg-project__cat`},Ml={class:`cg-project__status`},Nl={class:`cg-project__title`},Pl={class:`cg-project__text`},Fl={class:`cg-section cg-section--cta`},Il={class:`cg-container text-center`,"data-aos":`zoom-in`},Ll=x(a({__name:`index`,setup(e){C({title:`Inicio`,meta:[{name:`description`,content:w.description}]}),E({layout:`default`});let t=k;return(e,a)=>{let o=y(`v-btn`),c=ol,l=T,d=D,f=y(`v-col`),m=y(`v-row`),x=y(`v-icon`);return v(),_(`div`,null,[r(`section`,sl,[a[3]||=r(`div`,{class:`cg-hero__glow`,"aria-hidden":`true`},null,-1),a[4]||=r(`div`,{class:`cg-hero__grid`,"aria-hidden":`true`},null,-1),r(`div`,cl,[r(`div`,ll,[a[2]||=r(`img`,{class:`cg-hero__logo`,src:`/img/logo-codegrown-vectorizado-solologo.png`,alt:`CodeGrown`,width:`96`,height:`96`},null,-1),r(`h1`,ul,p(i(w).tagline),1),r(`p`,dl,p(i(w).description),1),r(`div`,fl,[u(o,{class:`text-none`,color:`primary`,size:`large`,rounded:`lg`,to:`/portfolio`,"prepend-icon":`mdi-folder-outline`},{default:h(()=>[...a[0]||=[s(`Ver portafolio`,-1)]]),_:1}),u(o,{class:`text-none`,variant:`outlined`,color:`secondary`,size:`large`,rounded:`lg`,to:`/contact`,"prepend-icon":`mdi-email-outline`},{default:h(()=>[...a[1]||=[s(`Contactar`,-1)]]),_:1})])]),r(`div`,pl,[u(c,{size:420,float:``,interactive:``,"aria-label":`Estrella de protones CodeGrown — arrastra esfera u órbitas para girar`})])])]),r(`section`,ml,[r(`div`,hl,[u(l,{eyebrow:`Qué hacemos`,title:`Valor, madurez y apoyo continuo`,subtitle:`Acompañamos con visión de largo plazo: claridad en las prioridades y compromiso con lo que ya está en marcha.`,align:`center`}),u(m,{dense:``},{default:h(()=>[(v(!0),_(S,null,g(i(O).slice(0,3),(e,t)=>(v(),n(f,{key:e.id,cols:`12`,md:`4`,"data-aos":`fade-up`,"data-aos-delay":t*80},{default:h(()=>[u(d,{icon:e.icon,title:e.title,text:e.subtitle,to:`/services`,cta:`Ver servicios`},null,8,[`icon`,`title`,`text`])]),_:2},1032,[`data-aos-delay`]))),128))]),_:1})])]),r(`section`,gl,[r(`div`,_l,[r(`div`,vl,[u(l,{class:`mb-0`,eyebrow:`Productos`,title:`Productos propios`,subtitle:`Lukeate, Hydra y Bills — plataformas que operamos y evolucionamos con continuidad.`}),u(o,{class:`text-none`,variant:`tonal`,color:`primary`,rounded:`lg`,to:`/products`,"append-icon":`mdi-arrow-right`},{default:h(()=>[...a[5]||=[s(`Ver todos`,-1)]]),_:1})]),u(m,{dense:``},{default:h(()=>[(v(!0),_(S,null,g(i(t),(e,t)=>(v(),n(f,{key:e.id,cols:`12`,sm:`6`,md:`4`,"data-aos":`fade-up`,"data-aos-delay":t*60},{default:h(()=>[(v(),n(b(e.href?`a`:`div`),{class:`cg-project`,href:e.href,target:e.href?`_blank`:void 0,rel:e.href?`noopener`:void 0},{default:h(()=>[r(`div`,yl,[e.image?(v(),_(`img`,{key:0,src:e.image,alt:e.title,width:`28`,height:`28`},null,8,bl)):(v(),n(x,{key:1,icon:e.icon,color:`primary`,size:`28`},null,8,[`icon`]))]),r(`div`,xl,[r(`span`,Sl,p(e.category),1),r(`span`,Cl,p(i(A)(e.status)),1)]),r(`h3`,wl,p(e.title),1),r(`p`,Tl,p(e.subtitle),1)]),_:2},1032,[`href`,`target`,`rel`]))]),_:2},1032,[`data-aos-delay`]))),128))]),_:1})])]),r(`section`,El,[r(`div`,Dl,[u(l,{class:`mb-8`,eyebrow:`Desarrollo`,title:`Desarrollo de plataformas`,subtitle:`Diseñamos y construimos plataformas a medida cuando el negocio necesita una base digital sólida y sostenible.`,align:`center`}),u(m,{dense:``,justify:`center`},{default:h(()=>[(v(!0),_(S,null,g(i(j),(e,t)=>(v(),n(f,{key:e.id,cols:`12`,sm:`6`,md:`4`,"data-aos":`fade-up`,"data-aos-delay":t*60},{default:h(()=>[(v(),n(b(e.href?`a`:`div`),{class:`cg-project`,href:e.href,target:e.href?`_blank`:void 0,rel:e.href?`noopener`:void 0},{default:h(()=>[r(`div`,Ol,[e.image?(v(),_(`img`,{key:0,src:e.image,alt:e.title,width:`28`,height:`28`},null,8,kl)):(v(),n(x,{key:1,icon:e.icon,color:`primary`,size:`28`},null,8,[`icon`]))]),r(`div`,Al,[r(`span`,jl,p(e.category),1),r(`span`,Ml,p(i(A)(e.status)),1)]),r(`h3`,Nl,p(e.title),1),r(`p`,Pl,p(e.subtitle),1)]),_:2},1032,[`href`,`target`,`rel`]))]),_:2},1032,[`data-aos-delay`]))),128))]),_:1})])]),r(`section`,Fl,[r(`div`,Il,[a[7]||=r(`h2`,{class:`cg-display text-h4 mb-3`},`¿Hablamos de tu próximo paso?`,-1),a[8]||=r(`p`,{class:`cg-muted mb-6`},`Cuéntanos el contexto. Te proponemos un camino claro y realista.`,-1),u(o,{class:`text-none`,color:`primary`,size:`large`,rounded:`lg`,to:`/contact`,"prepend-icon":`mdi-rocket-launch-outline`},{default:h(()=>[...a[6]||=[s(`Empezar conversación`,-1)]]),_:1})])])])}}}),[[`__scopeId`,`data-v-8187da3e`]]);export{Ll as default};